...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=542803230ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="116.167">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tables récentes" class="drop_button btn">Récentes</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestion_abonnes&table=administrateurs">`gestion_abonnes`.`administrateurs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestion_abonnes&table=admistrateurs">`gestion_abonnes`.`admistrateurs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestion_abonnes&table=abonnees">`gestion_abonnes`.`abonnees`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=demo&table=annuaire">`demo`.`annuaire`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=logement&table=bien">`logement`.`bien`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=logement&table=prorietaire">`logement`.`prorietaire`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=simplon_data&table=apprendre">`simplon_data`.`apprendre`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=simplon_data&table=user">`simplon_data`.`user`</a></li></ul></div><div class="drop_list"><button title="Tables préférées" class="drop_button btn">Préférées</button><ul id="pma_favorite_list"><li class="warp_link">Pas de tables préférées.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="5a79634c514b615336635828702d732c">
...
</span><small>Définir à 0 pour replier le panneau de navigation.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom field-error" value="116.167"><a class="restore-default hide" href="#NavigationWidth" title="Restaurer la valeur par défaut"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a>
        <dl class="inline_errors"><dd>Nombre non négatif !</dd></dl></td></tr></table>
</fieldset>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Faire Entrée pour exécuter la requête                    </span>
                            ...
                            targetdb="gestion_abonnes" targettable="admistrateurs">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `admistrateurs`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="gestion_abonnes" targettable="admistrateurs">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            targetdb="gestion_abonnes" targettable="administrateurs">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">
            RENAME TABLE `gestion_abonnes`.`admistrateurs`
                  TO `gestion_abonnes`.`administrateurs`;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="gestion_abonnes" targettable="administrateurs">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `administrateurs`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="gestion_abonnes" targettable="administrateurs">
                            <div class="action_content">
