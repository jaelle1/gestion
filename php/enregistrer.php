    ...
    <div class="container ">
        <div class="row coll">
            <div class="col-md-12 conect ">
                <span class="enre"><a href="./enregistrement.php">Enregistrer</a></span><br><br>
                <span class="list"><a href="./liste.php">Lister</a></span><br>

            </div>
            <div class="col-md-12 conect">
                <span class="ferm"><a href="user.php">Fermer</a></span>
            </div>
        </div>
    </div>
